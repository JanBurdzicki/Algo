...
// TODO: zastanowic sie czy trzymac tablice globalnie, czy przekazywac przez referencje
// TODO: Zastanowic sie czy nie zrobic structa na przedzialy
...
// TODO: zastanowic sie czy nie chcemy zwracac wektora
...
void combine(vector <int>& liczby, int L_1, int R_1, int L_2, int R_2)
{
	...
	{
		// TODO: zastanowic sie czy < czy <=, bo np do inwersji przydaje sie <=
...
// Divide, dzielimy ciag liczb na ...
void merge_sort(vector <int>& liczby, int L, int R)
{
	int mid = (L + R) / 2;

	// if(L < R) -> moze tez byc, TODO: zastanowic sie ktore lepsze
	if(L != R)
	{
